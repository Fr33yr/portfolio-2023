...
export const data = [
  ...
  {
    title: "Capacitechkids",
    tecnologies: ["React", "Redux", "SWR", "Sequelize", "Express"],
    description: `This SPA is a free e-learning platform that includes course filtering, an administrator panel to control users 
